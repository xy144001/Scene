...
OBJECT_KEYWORDS = {
    ...
    "bookcase": ("bookcase", "bookcases", "bookshelf", "bookshelves", "built-in bookshelf", "built-in bookshelves", "书架", "书柜"),
    "side_table": ("side table", "side tables", "end table", "end tables", "边几", "角几"),
    "basket": ("basket", "woven basket", "编织篮", "篮子"),
    "books": ("stacked books", "books", "书堆", "书本"),
    "ceramics": ("ceramic", "ceramics", "vase", "花瓶", "陶瓷"),
    "accent_chair": ("accent chair", "lounge chair", "armchair", "休闲椅", "单人椅"),
    "rug": ("rug", "carpet", "地毯"),
    "window": ("window", "窗户", "窗"),
